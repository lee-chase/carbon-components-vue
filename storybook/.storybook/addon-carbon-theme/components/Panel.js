...
const typeTokenPairings = ['12-16', '14-18', '14-20', '16-24', '16-22', '20-26', '28-36'];
      ...
      <Form>
        {Object.keys(typeTokenDefaults).map(tokenName => (
          <Form.Field key={tokenName} label={`${tokenName}:`}>
            <Form.Select name={tokenName} onChange={handleTokenChange} size="flex" value={currentTypeTokens[tokenName]}>
