<template>
  <div class="cv-combo-box" :class="`${carbonPrefix}--list-box__wrapper`" @focusout="onFocusOut">
    <label
      v-if="title"
      :for="uid"
      :class="[`${carbonPrefix}--label`, toClassObject([`${carbonPrefix}--label--disabled`, disabled])]"
      >{{ title }}</label
    >
    ...
    <div
      ...
      :class="[
        ...
        toClassObject([`${carbonPrefix}--form__helper-text--disabled`, disabled]),
      ]"
    >
    ...
    <div
      ...
      :class="[
        ...
        toClassObject([
          ...
          theme === 'light',
          `${carbonPrefix}--combo-box--expanded`,
          open,
          `${carbonPrefix}--list-box--expanded`,
          open,
      ...
      >
        ...
        <div
          :class="[
            ...
            toClassObject([`${carbonPrefix}--list-box__menu-icon--open`, open]),
          ]"
          role="button"
        >
      ...
      <div v-show="open" :id="uid" :class="`${carbonPrefix}--list-box__menu`" role="listbox" ref="list">
        <div
          ...
          :class="[
            ...
            toClassObject([`${carbonPrefix}--list-box__menu-item--highlighted`, highlighted === item.value]),
          ]"
          ref="option"
